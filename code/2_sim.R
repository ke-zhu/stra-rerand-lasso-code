...
toc()
save(Z_design_rep, file = str_glue("output/result/des_c{job_id}.RData"))
...
toc()
save(inf_tab, file = str_glue("output/result/inf_c{job_id}.RData"))
...
toc()
save(sum_tab, file = str_glue("output/sum_c{job_id}.RData"))
